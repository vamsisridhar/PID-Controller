...
ADC_Setup_X: ; measure from ((PORTF) and 0FFh), 5, a
    bsf LATE, DRIVEA, A
    bcf LATE, DRIVEB, A

    banksel ANCON1
    bsf ((ANCON1) and 0FFh), 2, b ; set ((PORTF) and 0FFh), 5, a to analog
    movlb 0x00
    movlw 00101001B ; 0, 01010 - select ((PORTF) and 0FFh), 5, a,
...
ADC_Setup_Y: ; measure from ((PORTF) and 0FFh), 2, a
    bcf LATE, DRIVEA, A
    bsf LATE, DRIVEB, A
    banksel ANCON0
    bsf ((ANCON0) and 0FFh), 7, b ; set ((PORTF) and 0FFh), 2, a to analog
    movlb 0x00
    movlw 00011101B ; 0, 01010 - select ((PORTF) and 0FFh), 5, a,
    movwf ADCON0, A ; and turn ADC on
    movlw 0x00 ; Select 0V positive reference
    movwf ADCON1, A ; 0V for -ve reference and -ve input
    movlw 0xF6 ; Right justified output
